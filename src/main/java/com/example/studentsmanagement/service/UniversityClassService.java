...
public class UniversityClassService {
    ...
    public UniversityClass addClass(UniversityClass universityClass) {
        ...
        if (universityClass.getYear() < currentYear ) {
            throw new InvalidUniversityClassException("The year is invalid, cannot add class in the past");
        }

        if (universityClass.getYear() > currentYear + 1) {
            throw new InvalidUniversityClassException("The year is invalid, cannot add class in the future");
        }
